...
const Wrong = (props) => {
    const defaultOptions = {
        loop: false,
        autoplay: true, 
        animationData: require('../../assets/4903-failed.json'),
        rendererSettings: {
    ...
    return (
        <div>
            ...
            {
                props.statusCode==205?
                <div className="mt-5 mx-auto px-5 py-3 text-3xl font-bold text-center">
                   Insufficient Balance
                </div>:
                props.statusCode==210?
                <div  className="mt-5 mx-auto px-5 py-3 text-xl font-bold text-center">
                    This User entry already exists try with a different username or email
                </div>
                :
                <div  className="mt-5 mx-auto px-5 py-3 text-3xl font-bold text-center">
                    Some Error happended
                </div>
            }
            {
                props.createUser?null:
